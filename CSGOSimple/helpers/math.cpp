...
namespace Math
{
	...
	Vector AngleVectors1(QAngle angle)
	{
		auto sy = sin(angle.yaw / 180.f * static_cast<float>(3.141592654f));
		auto cy = cos(angle.yaw / 180.f * static_cast<float>(3.141592654f));

		auto sp = sin(angle.pitch / 180.f * static_cast<float>(3.141592654f));
		auto cp = cos(angle.pitch / 180.f* static_cast<float>(3.141592654f));
